> **⚠️ v3 README — historical archive.** This document describes the v3 headless pipeline as it was announced. Karajan v4 attaches to the AI agent you already work with — start at the **[current README](../README.md)** or [karajancode.com](https://karajancode.com). The pipeline described below lives on as v4's headless mode.
