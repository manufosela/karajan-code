        ...
        "config": (
            {
                ...
                "page_size": 50,
                "default_query": (
                    "orthodontics OR clear aligners OR malocclusion OR tooth movement OR dental biomechanics"
                ),
        ...
        "value": (
            {
                ...
                "manufacturing": [
                    "thermoforming",
                    "direct 3D printing",
                    "additive manufacturing dental",
                    "dental 3D printing",
                    "SLA dental",
                    "DLP dental",
                    "aligner production",
                    "mass customization dental",
                ],
                "emerging": [
                    "AI orthodontics",
                    "machine learning dental",
                    "deep learning dental",
                    "computer vision dental",
