...
### v4.20.0 — infra is code too (current, v4.20.1)

Patch v4.20.1 the same day: `kj start` finally sees the project it is standing in — the sweep received an undefined root and read ANY project as empty; now it resolves `cwd` and refuses a missing root out loud.
