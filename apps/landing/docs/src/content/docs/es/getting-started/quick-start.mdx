...
La forma más potente de usar Karajan Code es como **servidor MCP** dentro de tu agente de IA. Tras `npm install -g @karajan-family/code`, el servidor MCP se auto-registra en Claude y Codex.
