...
The most powerful way to use Karajan Code is as an **MCP server** inside your AI agent. After `npm install -g @karajan-family/code`, the MCP server auto-registers in Claude and Codex.
